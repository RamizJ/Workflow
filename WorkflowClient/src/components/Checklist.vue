<template lang="pug">
  el-card.checklist(shadow="never" :body-style="{ padding: '0px 10px' }")
    ...
    div.checklist__item(
      ...
      el-checkbox(v-model="currentChecklist[index].completed" @change="onCheck(index)")
      el-input(v-model="currentChecklist[index].title" @keyup.delete.native="onDelete(index)")
</template>

...
namespace Workflow.DAL.Migrations
{
    ...
    [Migration("20210114013605_GoalTimespansToHours")]
    partial class GoalTimespansToHours
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workflow.DAL.Models.Goal", b =>
                {
                    ...
                    b.Property<double?>("ActualPerformingHours")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("EstimatedPerformingHours")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Workflow.DAL.Models.GoalMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Workflow.DAL.Models.UserGoalMessage", b =>
                {
                    b.Property<int>("GoalMessageId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("GoalMessageId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("UserGoalMessages");
                });
            ...
            modelBuilder.Entity("Workflow.DAL.Models.UserGoalMessage", b =>
                {
                    b.HasOne("Workflow.DAL.Models.GoalMessage", "GoalMessage")
                        .WithMany("MessageSubscribers")
                        .HasForeignKey("GoalMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Workflow.DAL.Models.ApplicationUser", "User")
                        .WithMany("GoalMessages")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GoalMessage");
            ...
            modelBuilder.Entity("Workflow.DAL.Models.ApplicationUser", b =>
                {
                    b.Navigation("GoalMessages");

                    b.Navigation("GoalObserver");

                    b.Navigation("ProjectsRoles");
            ...
            modelBuilder.Entity("Workflow.DAL.Models.GoalMessage", b =>
                {
                    b.Navigation("MessageSubscribers");
                });

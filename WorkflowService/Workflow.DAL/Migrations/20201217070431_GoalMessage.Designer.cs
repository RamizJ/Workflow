...
namespace Workflow.DAL.Migrations
{
    ...
    [Migration("20201217070431_GoalMessage")]
    partial class GoalMessage
    {
            ...
            modelBuilder.Entity("Workflow.DAL.Models.UserGoalMessage", b =>
                {
                    ...
                    b.HasOne("Workflow.DAL.Models.GoalMessage", null)
                        .WithMany("UnreadUsers")
